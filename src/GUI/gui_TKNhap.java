...
public class gui_TKNhap {
    Scanner sc = new Scanner(System.in);
    public gui_TKNhap() {
    }
    public void TrangThongKeNhap() {
        System.out.println("-------------     Chào Mừng Bạn Đến Với Trang thống kê Nhập   -------------");
    ...
    public void TK_NgayNhap(Date d1, Date d2) {
